...
from src.common.core.db import get_session, push_logs_to_db
from src.common.models.db.provider import ProviderExecutionLog
...
CONFIG = {
    ...
    "handlers": {
        ...
        "workflowhandler": {
            ...
            "class": "src.common.logging.WorkflowDBHandler",
    ...
    "filters": {  # Add filters section
        "thread_context": {"()": "src.common.logging.WorkflowContextFilter"}
    },
    "loggers": {
        "": {
...
def setup_logging():
    ...
    if KEEP_FLUENTBIT:
        CONFIG["handlers"]["fluentbit"] = {
            "level": "DEBUG",
            "formatter": ("json"),
            "class": "src.common.logging.FluentBitHandler",

...
from src.common.core.metrics import workflow_execution_duration
...
from src.workflowmanager.workflowscheduler import WorkflowScheduler, timing_histogram
                ...
                for trigger in workflow.workflow_triggers:
                    ...
                    if os.environ.get("REDIS", "false").lower() == "true":
                        try:
                            ...
                            from src.common.consts import KEEP_ARQ_QUEUE_WORKFLOWS

...
from src.common.models.user import ResourcePermission, Role, User
...
from src.identitymanager.authverifierbase import ALL_RESOURCES, AuthVerifierBase
from src.identitymanager.rbac import get_role_by_role_name

rbac_module = importlib.import_module("src.identitymanager.rbac")
PREDEFINED_ROLES = []
